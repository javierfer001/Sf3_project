...
$to_address = "jjrattan1976@gmail.com"; 

// Enter your secret key (google captcha)
$secret = "6LfyCR8TAAAAADJX0TZ3TeROueG8RTUi0Gy_CvY-";
...
// Message Content
$body = "You have been contacted from JJRattan.com by $name." .  "\r\n" . "\r\n";
$content = $comment . "\r\n" . "\r\n";
$reply = "You can reply to $name at: $email.";
